                ...
                {Object.entries(social).map(([platform, url]) => (
                  socialIcons[platform] && (
                    <a
                      ...
                      className="w-10 h-10 bg-secondary-800 rounded-lg flex items-center justify-center text-secondary-400 hover:text-white hover:bg-primary-600 transition-all duration-300 transform hover:scale-110"
                    >
                      {socialIcons[platform]}
                    </a>
                  )
