      ...
      <div className="container-custom px-3 sm:px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="prose prose-sm sm:prose-base lg:prose-lg text-secondary-700 max-w-none">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 xl:gap-6">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="card p-3 sm:p-4 lg:p-6 text-center transform hover:scale-105 transition-all duration-300"
                >
                  <div className="text-xl sm:text-2xl lg:text-3xl font-display font-bold text-primary-600 mb-1 sm:mb-2">
                    {stat.number}
                  </div>
            ...
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              {highlights.map((highlight, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-2 sm:space-x-3 lg:space-x-4 p-2 sm:p-3 lg:p-4 rounded-lg hover:bg-white transition-colors duration-300"
                >
                  <div className="text-lg sm:text-xl lg:text-2xl flex-shrink-0">
                    {highlight.icon}
                  </div>
                  <div>
                    <h3 className="font-semibold text-secondary-900 mb-1 text-xs sm:text-sm lg:text-base">
                      {highlight.title}
                    </h3>
