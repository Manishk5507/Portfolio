    ...
    <section id="contact" className="section-padding bg-secondary-50">
      <div className="container-custom px-3 sm:px-4 lg:px-8">
        <div className="text-center mb-6 sm:mb-8 lg:mb-12 xl:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold text-secondary-900 mb-2 sm:mb-3 lg:mb-4">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            <div>
              <h3 className="text-lg sm:text-xl lg:text-2xl font-display font-semibold text-secondary-900 mb-3 sm:mb-4 lg:mb-6">
                Get in Touch
              </h3>
              <p className="text-sm sm:text-base text-secondary-700 leading-relaxed mb-4 sm:mb-6 lg:mb-8">
              ...
              {contactMethods.map((method, index) => (
                <div key={index} className="card p-3 sm:p-4 lg:p-6 hover:shadow-lg transition-all duration-300">
                  <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4 mb-2 sm:mb-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-primary-100 rounded-lg flex items-center justify-center text-primary-600 flex-shrink-0">
                      {method.icon}
                    </div>
                    <div className="min-w-0 flex-1">
                      <h4 className="font-semibold text-secondary-900 text-xs sm:text-sm lg:text-base">{method.title}</h4>
                  ...
                  {method.href ? (
                    ...
                    <p className="text-secondary-700 font-medium text-xs sm:text-sm lg:text-base">{method.value}</p>
                  )}
                </div>
              ))}
            </div>
            ...
            {/* Availability Status */}
            <div className="card p-3 sm:p-4 lg:p-6 bg-gradient-to-r from-green-50 to-green-100 border border-green-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 lg:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 py-2 sm:px-4 sm:py-2.5 lg:py-3 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors duration-300 text-sm sm:text-base"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full px-3 py-2 sm:px-4 sm:py-2.5 lg:py-3 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors duration-300 resize-none text-sm sm:text-base"
